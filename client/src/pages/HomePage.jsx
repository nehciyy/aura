  ...
  const [audioFiles, setAudioFiles] = useState([
    {
      ...
      description: "A fascinating podcast episode about technology.",
      category: "podcast",
    ...
    },
    {
      ...
      description: "An insightful discussion on current events.",
      category: "podcast",
    ...
    },
    {
      ...
      title: "song3.mp3",
      src: "/audio/song3.mp3",
      description: "A catchy tune to brighten your day.",
      category: "music",
    ...
    },
    {
      ...
      description: "An exclusive interview with a renowned author.",
      category: "interview",
    ...
    },
    {
      ...
      description: "A relaxing lo-fi track for studying.",
      category: "music",
